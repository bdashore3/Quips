...
struct AboutView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("Quips is a free and open source application developed by Brian Dashore under the GNU-GPLv3 license.")
                .padding()
            ...
            List {
                ...
                ListRowLinkView(text: "GitHub repository", link: "https://github.com/bdashore3/Quips")
            }
